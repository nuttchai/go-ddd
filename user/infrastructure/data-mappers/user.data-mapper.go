...
func (m *UserDataMapper) ToDomainEntity(dalEntity *model.User) (*entity.User, error) {
	return &entity.User{
		Id:        dalEntity.Id,
...
func (m *UserDataMapper) ToDalEntity(domainEntity *entity.User) (*model.User, error) {
	return &model.User{
		Id:        domainEntity.Id,
